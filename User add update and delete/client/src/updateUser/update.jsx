  ...
  return (
    <div className="addUser">
      ...
      <div className="inputGroup">
          ...
          <input type="text" id="name" onChange={inputHandler} value={user.name} name="name" autoComplete="off" placeholder="Enter your Name"/>
        </div>
        <div className="inputGroup">
          <label htmlFor="email">E-mail:</label>
          <input type="email" id="email" onChange={inputHandler} value={user.email} name="email" autoComplete="off" placeholder="Enter your Email"/>
        </div>
        <div className="inputGroup">
